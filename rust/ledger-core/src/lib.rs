...
pub const ORIGIN: &str = "verderer.watchdog/m1-log";
...
/// Verify a `verderer.proofbundle/v1` fully offline (DESIGN §6.4): the artifact bytes hash
...
pub fn verify_bundle(
    ...
    if v["schema"] != "verderer.proofbundle/v1" {
