...
USER_AGENT = "VerdererWatchdog/0.0 (+https://github.com/satchmakua/verderer) polite-archival-collector; headless"
...
def playwright_engine(url: str, *, timeout: float = 30.0, settle: float = 3.0) -> RenderResult:
    ...
    (``pip install 'verderer[render]'`` + ``playwright install chromium``).
...
class RenderCollector:
    ...
    def collect(self, target: Target) -> Collected:
        ...
        manifest = {
            "schema": "verderer.captured_requests/v1",
